...
$lang['about_we_label'] = "Who We Are";
$lang['about_we_content'] = "<p>At <span class='text-green'>SporGlo</span>, we are a passionate team dedicated to revolutionizing the world of sports recruitment. Our platform is built on the belief that talent knows no boundaries, and every aspiring player deserves a chance to shine on the global stage. We bring together a diverse community of players, clubs, medical professionals, technical staff, and enthusiasts, fostering a dynamic ecosystem where opportunities abound.</p><p>With a commitment to inclusivity and fairness, we strive to bridge the gap between undiscovered talent and clubs seeking the next sports stars. <span class='text-green'>SporGlo</span> is more than a platform; it's a global hub where dreams meet opportunities, and where the future of sports is shaped by the passion and potential of individuals.</p><p>Join us on this exciting journey as we redefine sports recruitment, unlocking possibilities for players and clubs worldwide.</p>";
$lang['our_vision_label'] = "Our Vision";
...
$lang['categorie_info'] = "Explore a world of talent and opportunities across diverse sports on SporGlo. From aspiring
