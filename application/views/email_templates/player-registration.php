					...
					<tr>
						<td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							...
							<p style="margin: 0; margin-top:10px;">
								We’re excited to welcome you to <span style="color: #01d099;"><?= APP_NAME ?></span>! Before you begin your journey, we need to verify your account. Follow these steps to complete the verification process:</p>
										...
										<table border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td align="center" bgcolor="#01d099" style="border-radius: 6px;">
													<a href="<?= $verification_link ?>" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Verify Your Account</a>
												</td>
											</tr>
										</table>
									</td>
