			...
			<div class="col-md-4">
				<div class="card border-radius-none custom-login-card">
					<div class="card-body border-radius-none">
						...
						<small class="text-black">Welcome back! Log in here to access your club's account and manage team activities effortlessly</small>
						<hr>
						<form action="login/club" method="post" id="form" onsubmit="validate()">
							...
							<div class="form-group">
								<a href="register/club" class=""><span class="text-black">Don't Have an Acccount?</span> <span class="text-green">Register Your Account</span></a>
							</div>
						</form>
					</div>
				</div>
