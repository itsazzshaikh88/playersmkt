<div class="default-section mt-5 mb-5">
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-md-8">
				<div class="alert alert-danger d-none" id="message-container">
					<p class="pb-0 mb-0"></p>
				</div>
					...
					<div class="card-body border-radius-none">
						...
						<form action="">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" id="email_address" name="email_address" class="form-control" placeholder="Enter your email address" required>
								</div>
							</div>
							<div class="form-group row">
