				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<h2>Congratulations, <span class="text-green"><?= "$player_detail[first_name] $player_detail[last_name]" ?></span></h2>
							...
							<div class="text-center">
								<a href="login/player" class="btn btn-sms btn-primary mt-3 w-50">Click to Login <i class="fa-solid fa-arrow-right-to-bracket"></i></a>
							</div>
						</div>
					</div>
				</div>
